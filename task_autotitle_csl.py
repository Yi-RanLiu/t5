...
# 加载数据集
train_data = load_data('/root/autodl-tmp/t5_in_bert4keras/data/train.tsv')
valid_data = load_data('/root/autodl-tmp/t5_in_bert4keras/data/val.tsv')
# test_data = load_data('/root/autodl-tmp/t5_in_bert4keras/data/test.tsv')
